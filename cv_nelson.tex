...
frameworks. After refactoring, continued to donate hosting with personal jar of
change.
...
\begin{packed_item}
    ...
    \item \textbf{Misc. Skills} -- AMPQ, Logstash, OpenStreetMap, AutoHotKey, ARMv6/x86 ASM reverse engineering, and \LaTeX
\end{packed_item}
