...
I managed technical aspects of many committee activities including its website
and software that's being used.

I have also designed, setup, configure, and maintained a Linux, Windows, and
pfSense-based network and accompanying virtual machines for file sharing and
network traffic management for LAN Parties for 150 or more attendees for every
quarter since Fall of 2010.
...
\begin{itemize}
    ...
    \item Web Development -- HTML, CSS, RoR, JavaScript, REST, JSON, and XML
