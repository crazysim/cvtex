...
\begin{packed_item}
\item \textbf{Languages} -- Verilog, Scala, Java, Ruby, Object-oriented C/C++, and Python
\item \textbf{Operating Systems and Platforms}
    ...
    \item \textbf{IDE} -- IntelliJ IDEA, Eclipse, and Xilinx
    \item \textbf{Text Editors} -- Vim
    \item \textbf{Databases} -- PostgreSQL and SQLite
    \item \textbf{Web Development} -- HTML5, SCSS, RoR, Play!, JavaScript, jQuery, REST, JSON, and XML
    \item \textbf{Analog Electronics} 
    \item \textbf{Misc. Skills} -- OpenStreetMap, Git, and \LaTeX
\end{packed_item}
