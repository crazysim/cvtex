...
\def\myaddress{Santa Barbara, CA and Los Angeles, CA}
...
\begin{packed_item}
    ...
    \item CS177 -- Computer Security
    \item ECE194BB -- Android Development
\end{packed_item}
...
Maintained existing website and VPS. Currently drafting and advising plans to
help organization save a dramatic amount of money on website hosting, increase
website performance, reduce maintenance, and provide for the possibility of
effortless scaling 
...
fixes, quick-menu, and dashboard per course page. Audience of 80+ users.
...
\item \textbf{Operating Systems and Platforms}
    ...
    \item \textbf{Web Development} -- HTML5, SCSS, LESS, Ruby on Rails, Play Framework 2, JavaScript, jQuery, Zurb Framework, Bootstrap, REST, and JSON
    \item \textbf{Misc. Skills} -- OpenStreetMap, \texttt{git}, AutoHotKey, and \LaTeX
\end{packed_item}
